...
<head>
    ...
    <link rel="stylesheet" href="/fort-energy/public/assets/css/index.css">
    <?php if (isset($pageCss)): ?>
        <link rel="stylesheet" href="/fort-energy/public/assets/css/<?= htmlspecialchars($pageCss) ?>.css">
    <?php endif; ?>
</head>
...
<body>
    ...
    <script src="/fort-energy/public/assets/js/main.js"></script>
</body>
